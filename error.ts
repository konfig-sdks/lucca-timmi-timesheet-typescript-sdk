...
/**
 * This class provides a wrapper for network errors when making requests to Timmi Timesheet API
 */
export class LuccaTimmiTimesheetError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "LuccaTimmiTimesheetError";
